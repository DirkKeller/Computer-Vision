		...
		Camera* camera)
{
	...
	//std::cout << "Camera location" << location << endl;
	...
	//GaussianBlur(hsv_image, hsv_image, Size(5, 5), 0);

	split(hsv_image, channels);  // Split the HSV-channels for further analysis

	//Background subtraction H // Hue
	Mat foreground, background,  tmp;
	Mat first, second, third, first_channel, second_channel, third_channel;
	...
	morphologyEx(foreground, foreground, MORPH_OPEN, Mat(), Point(-1,-1), 1);  
